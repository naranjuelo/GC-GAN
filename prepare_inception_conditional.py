...
# 25/05/2024: use maskdataset conditional to support gaze-labeled data
...
def get_dataset(args):
    if args.dataset_type == 'mask':
        ...
        dataset = MaskDataset_conditional(args.path, resolution=args.size)
    else:
...
if __name__ == '__main__':
    ...
    loader = DataLoader(dset, shuffle=False, batch_size=args.batch, drop_last=False, num_workers=1)
